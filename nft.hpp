...
CONTRACT nft : public inery::contract {
	...
	using account_index = inery::multi_index<"accounts"_n, account>;

	using currency_index = inery::multi_index<"stat"_n, stats,
	                       indexed_by< "byissuer"_n, const_mem_fun< stats, uint64_t, &stats::get_issuer> > >;

	using token_index = inery::multi_index<"token"_n, token,
